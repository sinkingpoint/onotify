...
export const TLSConfigSpec = z
  .object({
    ...
    min_version: z
      .string()
      .optional()
      .openapi({ description: "the minimum version of TLS to support" }),
    max_version: z
      .string()
      .optional()
      .openapi({ description: "the maximum version of TLS to support" }),
  })
  .strict()
...
export const OAuth2ConfigSpec = z
  .object({
    ...
    client_secret: z
      .string()
      .optional()
      .openapi({ description: "the client secret to present" }),
    ...
    scopes: z
      .array(z.string())
      .default([])
      .openapi({ description: "the scopes for the token request" }),

    // The URL to fetch the token from.
    token_url: z
      .string()
      .openapi({ description: "the URL to fetch the token from" }),
    ...
    proxy_url: z
      .string()
      .optional()
      .openapi({ description: "Optional proxy URL" }),
  ...
  .object({
    ...
    basic_auth: z
      .object({
        username: z
          .string()
          .openapi({ description: "the username to present" }),
        password: z
          .string()
          .optional()
          .openapi({ description: "the password to use in basic auth" }),
        password_file: z
          .string()
          .optional()
          .openapi({ description: "the file to load the password from" }),
      })
      .optional()
    ...
    authorization: z
      .object({
        ...
        type: z
          .string()
          .default("Bearer")
          .openapi({ description: "the authentication type" }),
        // Sets the credentials. It is mutually exclusive with `credentials_file`.
        credentials: z
          .string()
          .optional()
          .openapi({ description: "the credendials to present" }),
        ...
        credentials_file: z
          .string()
          .optional()
          .openapi({ description: "the file to load the credentials from" }),
      })
      .optional()
    ...
    enable_http2: z
      .boolean()
      .default(true)
      .openapi({ description: "if true, send requests with HTTP2" }),
    // Optional proxy URL.
    proxy_url: z
      .string()
      .optional()
      .openapi({ description: "the url to use to proxy requests" }),
    ...
    follow_redirects: z
      .boolean()
      .default(true)
      .openapi({ description: "if true, follow HTTP 3xx redirects" }),
...
const baseRouteSpec = z
  .object({
    receiver: z
      .string()
      .optional()
      .openapi({ description: "the receier to send alerts to" }),
...
export const DiscordConfigSpec = z
  .object({
    ...
    send_resolved: z
      .boolean()
      .default(true)
      .openapi({ description: "whether to notify about resolved alerts" }),
    ...
    webhook_url: z
      .string()
      .optional()
      .openapi({ description: "the discord webhook URL" }),
    webhook_url_file: z
      .string()
      .optional()
      .openapi({ description: "the file to load the discord webhook URL" }),
...
export const EmailConfigSpec = z
  .object({
    ...
    to: z
      .string()
      .openapi({ description: "the email address to send notification to" }),
    ...
    smarthost: z
      .string()
      .optional()
      .openapi({ description: "The SMTP host through which emails are sent" }),

    // The hostname to identify to the SMTP server.
    hello: z
      .string()
      .optional()
      .openapi({ description: "the hostname to identify to the SMTP server" }),
...
export const MSTeamsConfigSpec = z
  .object({
    ...
    webhook_url: z
      .string()
      .optional()
      .openapi({ description: "the incoming webhook URL" }),
    webhook_url_file: z
      .string()
      .optional()
      .openapi({ description: "the file to load the incoming webhook from" }),
...
export const OpsGenieRespondersSpec = z
  .object({
    id: z
      .string()
      .optional()
      .openapi({ description: "the ID of the responder to send to" }),
    name: z
      .string()
      .optional()
      .openapi({ description: "the name of the responder to send to" }),
    username: z
      .string()
      .optional()
      .openapi({ description: "the username of the responder to send to" }),
    type: z
      .string()
      .openapi({ description: "the type of the responder to send to" }),
  })
  .strict()
...
export const PagerdutyLinkConfigSpec = z
  .object({
    href: z
      .string()
      .optional()
      .openapi({ description: "URL of the link to be attached." }),
    text: z.string().optional().openapi({
      description:
...
export const PagerdutyConfigSpec = z
  .object({
    ...
    routing_key: z
      .string()
      .optional()
      .openapi({ description: "the routing key to use when sending alerts" }),
    ...
    url: z
      .string()
      .optional()
      .openapi({ description: "the URL to send API requests to" }),
    ...
    severity: z
      .enum(["critical", "error", "warning", "lite"])
      .default("error")
      .openapi({
    ...
    source: z
      .string()
      .default("client")
      .openapi({ description: "unique location of the affected system" }),
    ...
    group: z
      .string()
      .optional()
      .openapi({ description: "a cluster or grouping of services" }),

    // The class/type of the event.
    class: z
      .string()
      .optional()
      .openapi({ description: "the class/type of the event" }),
...
export const PushoverConfigSpec = z
  .object({
    ...
    user_key: z
      .string()
      .optional()
      .openapi({ description: "the recipient users key" }),
    ...
    token: z
      .string()
      .optional()
      .openapi({ description: "the registered applications API token" }),
...
export const SlackActionConfirmFieldConfigSpec = z
  .object({
    ...
    dismiss_text: z
      .string()
      .default("")
      .openapi({ description: "the text of the dismiss action" }),
    ok_text: z
      .string()
      .default("")
      .openapi({ description: "the text of the ok action" }),
    title: z
      .string()
      .default("")
      .openapi({ description: "the text of the title" }),
  })
  .strict()
  .openapi({
...
export const SlackActionConfigSpec = z
  .object({
    ...
    url: z
      .string()
      .optional()
      .openapi({ description: "the URL to trigger the action" }),
    name: z
      .string()
      .optional()
      .openapi({ description: "the name of the action" }),
    ...
    style: z
      .string()
      .default("")
      .openapi({ description: "the style to apply to the action" }),
  })
  .strict()
...
export const SlackConfigSpec = z
  .object({
    ...
    api_url: z
      .string()
      .optional()
      .openapi({ description: "the slack webhook URL" }),
    api_url_file: z
      .string()
      .optional()
      .openapi({ description: "the file to load the slack webhook URL from" }),

    // The channel or user to send notifications to.
    channel: z
      .string()
      .openapi({ description: "the channel to send alerts to" }),

    // API request data as defined by the Slack webhook API.
    icon_emoji: z
      .string()
      .optional()
      .openapi({ description: "an emoji to use as the icon" }),
    icon_url: z
      .string()
      .optional()
      .openapi({ description: "a url to the icon to use for the alert" }),
    link_names: z
      .boolean()
      .default(false)
      .openapi({ description: "if true, link any @'s in the message" }),
    username: z
      .string()
