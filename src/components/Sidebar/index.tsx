...
export const SideBar = () => {
	...
	if (state === "open") {
		return (
			<nav class="flex flex-col rounded-r top-0 sticky side-bar min-w-64" aria-expanded="true">
		...
		return (
			<nav class="flex flex-col rounded-r top-0 sticky side-bar min-w-16" aria-expanded="false">
